...
import { DEFAULT_PLAYER_THEME_ID, MANA_THEME_COLORS, getManaThemeId } from '../themes';
...
export default function ProfilesScreen() {
  ...
  const selectedAccent = draft.manaColors.length ? MANA_THEME_COLORS[draft.manaColors[draft.manaColors.length - 1]] : MANA_THEME_COLORS.C;
    ...
    return <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.profileList}>
        ...
        : profiles.map((profile) => {
          ...
          const accent = profile.manaColors.length ? MANA_THEME_COLORS[profile.manaColors[profile.manaColors.length - 1]] : MANA_THEME_COLORS.C;
