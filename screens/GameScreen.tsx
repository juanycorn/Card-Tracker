  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.topBar}>
        ...
        <Pressable onPress={() => setSettingsOpen(true)} style={styles.settingsButton}><Text style={styles.settingsText}>⚙</Text></Pressable>
      </View>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#080A0F', paddingHorizontal: 12, paddingBottom: 8 }, topBar: { height: 64, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 5 }, topButton: { minWidth: 62, paddingVertical: 9, paddingHorizontal: 7, borderRadius: 11, backgroundColor: '#151820', alignItems: 'center' }, settingsButton: { width: 38, height: 38, borderRadius: 11, backgroundColor: '#151820', alignItems: 'center', justifyContent: 'center' }, settingsText: { color: '#C8CBD4', fontSize: 17 }, disabledButton: { opacity: 0.35 }, topButtonText: { color: '#AEB3C1', fontSize: 8, fontWeight: '900' }, turnStatus: { flex: 1, alignItems: 'center' }, gameMode: { fontSize: 7, fontWeight: '900' }, turnLabel: { color: '#676D7D', fontSize: 7, fontWeight: '900' }, turnName: { color: '#F4F3FF', fontSize: 14, fontWeight: '900' },
